...
function getFactors(number) {
    "use strict";
    var factors, possibleFactor, otherPossibleFactor, sqrt;
    factors = [];
    possibleFactor = 1;
    ...
    while (possibleFactor <= sqrt) { // avoid repeating factors
        if (number % possibleFactor === 0) {
            ...
            otherPossibleFactor = number / possibleFactor; // this is guaranteed to be whole number factor
    ...
    // first appearance of arrow function notation
}
// test
getFactors(35);
// --> [1, 35, 5, 7]
